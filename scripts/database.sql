...
CREATE DATABASE TRAB4BIM;

CREATE TABLE TRAB4BIM.tb_usuario( 
...
CREATE TABLE TRAB4BIM.tb_pessoa(
...
ALTER TABLE TRAB4BIM.tb_pessoa ADD FOREIGN KEY (id_usuario_cadastro) REFERENCES TRAB4BIM.tb_usuario(id_usuario);

INSERT INTO TRAB4BIM.tb_usuario (ds_login,ds_senha) VALUES('admin','123456');